    ...
    <v-card flat tile class="white--text py-12 px-5" width="100%">
      <v-row>
        <v-col cols="12" xs="12" sm="6" md="4" class="pa-16">
          <div class="text-center"><span>S</span><strong>hopi</strong></div>
        ...
        <v-col cols="12" xs="12" sm="6" md="4">
          ...
          <v-card-text class="grey--text">ProVideo</v-card-text>
          <v-card-text class="grey--text mt-n4">216 / C EAST Road</v-card-text>
